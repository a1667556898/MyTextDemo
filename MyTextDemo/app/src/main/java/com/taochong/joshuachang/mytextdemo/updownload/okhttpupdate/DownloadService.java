package com.taochong.joshuachang.mytextdemo.updownload.okhttpupdate;
...
public class DownloadService extends Service {
    ...
    private PendingIntent getInstallIntent() {
        File file = new File(Environment.getExternalStorageDirectory() + "APP文件名");//StorageUtil.DOWNLOAD_DIR
    ...
    private void downloadFile(String url) {
        ...
        OkHttpUtils.get().url(url).build().execute(new FileCallBack(Environment.getExternalStorageState(), "APP文件名") {//StorageUtil.DOWNLOAD_DIR
            @Override
